...
export const efficiency_enterprise_6328_dev_ed_Consumer_Key =
  process.env.abadancingqueen_Consumer_Key ?? '';
export const efficiency_enterprise_6328_dev_ed_SERTIFICCATE_KEY =
  process.env.abadancingqueen_SERTIFICCATE_KEY ?? '';
export const efficiency_enterprise_6328_dev_ed_SF_USERNAME =
  process.env.abadancingqueen_SF_USERNAME ?? '';

export const momentum_ruby_8063_dev_ed_Consumer_Key =
  process.env.abadancingqueen_Consumer_Key ?? '';
export const momentum_ruby_8063_dev_ed_SERTIFICCATE_KEY =
  process.env.abadancingqueen_SERTIFICCATE_KEY ?? '';
